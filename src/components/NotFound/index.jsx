  ...
  return (
    <body className="rocketBody">
      <div className="rocketDiv">
        <svg className="rocketSvg" width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="text">
        <h1 className="rocketH1">404 Error</h1>
        <h2>Could not launch :(</h2>
        <h3>
          Page Not Found - lets take you
          {' '}
          <a className="rocketA" href="https://twitter.com/namratapdr">BACK</a>
        </h3>
      </div>
    </body>
